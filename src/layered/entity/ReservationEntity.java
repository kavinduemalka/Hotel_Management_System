...
public class ReservationEntity {
    ...
    public ReservationEntity(String ID, String roomID, String customerID, Date reservationDate, LocalTime reservationTime, Double reservationAmount, boolean isCancelled) {
        this.ID = ID;
        this.roomID = roomID;
